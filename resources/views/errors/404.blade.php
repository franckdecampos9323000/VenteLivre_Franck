...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<!--begin::Head-->
	<head>
		<title>Erreur 404 - Vente de livreFormations</title>
		<meta charset="utf-8" />
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<!--end::Title-->
							<!--begin::Text-->
							<div class="fw-semibold fs-6 text-gray-500 mb-7">Désolé nous n'avons pas trouver la page que vous chercher</div>
							<!--end::Text-->
							<!--begin::Illustration-->
							<div class="mb-3">

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<!--begin::Head-->
	<head>
		<title>Erreur 403 - Vente de livreFormations</title>
		<meta charset="utf-8" />
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2hx text-gray-900 mb-4">Oops!- Erreur 403</h1>
							<!--end::Title-->
							<!--begin::Text-->
							<div class="fw-semibold fs-6 text-gray-500 mb-7">Désolé vous ne pouvez pas accéder à cette page</div>
							<!--end::Text-->
							<!--begin::Illustration-->
							<div class="mb-3">

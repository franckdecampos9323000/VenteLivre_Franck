...
<div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
    <div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1">
        ...
        <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-350px" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="true" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start">
            ...
            <form data-kt-search-element="form" class="d-none d-lg-block w-100 position-relative mb-5 mb-lg-0" autocomplete="off">
                ...
                <!--end::Icon-->
                <!--begin::Input-->
                <input type="text" class="search-input form-control form-control border-0 h-lg-45px ps-13" name="search" value="" placeholder="Rechercher..." data-kt-search-element="input" />
                <!--end::Input-->
                <!--begin::Spinner-->
                ...
                <div data-kt-search-element="wrapper">
                    ...
                    <div class="" data-kt-search-element="main">
                        ...
                        <div class="d-flex flex-stack fw-semibold mb-4">
                            <!--begin::Label-->
                            <span class="text-muted fs-6 me-2">Dernières recherches:</span>
                            <!--end::Label-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Items-->
                        <div class="scroll-y mh-200px mh-lg-325px">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Adobe première pro</a>
                                    <span class="fs-7 text-muted fw-semibold">#Formation</span>
                                </div>
                                <!--end::Title-->
                            </div>
                            <!--end::Item-->
                    ...
                    <div data-kt-search-element="empty" class="text-center d-none">
                        ...
                        <div class="pb-15 fw-semibold">
                            ...
                            <div class="text-muted fs-7">Patientez ou relancez la recherche</div>
                        </div>
                        <!--end::Message-->
                    </div>
                    <!--end::Empty-->
    ...
    <div class="app-navbar-item ms-2 ms-lg-6">
        ...
        <!-- <div class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative"" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            ...
            <span class="position-absolute top-0 start-100 translate-middle badge badge-circle badge-danger w-15px h-15px ms-n4 mt-3">+</span>
        </div> -->
        <!--begin::Menu-->
        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
            ...
            <!-- <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('assets/media/misc/menu-header-bg.jpg')">
                <span class="badge bg-primary text-inverse-primary py-2 px-3">Notifications</span>
            </div> -->
            <!--end::Heading-->
            <!--begin::Separator-->
                <!-- <div class="border-bottom border-gray-400 border-bottom-dashed"></div> -->
            <!--end::Separator-->
            <!--begin:Nav-->
            <!-- <div class="row g-0">
                <div class="">
                    <a href="" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                        ...
                        @if ($latestMessage)
                        <h1 class="text-center">{{ $latestMessage->title }}</h1>
                        <span class="fs-5 fw-semibold text-gray-900 mb-0">{!! Str::limit(html_entity_decode($latestMessage->content), 50) !!}</span>
                        @else
                        <h1 class="text-center">Aucune notification</h1>
                        @endif
                    </a>
                </div>
            </div> -->
            ...
            <!-- <div class="py-2 text-center border-top">
                <a href="{{ route('admin.messages.index') }}" class="btn btn-color-gray-600 btn-active-color-primary">Voir tout
    ...
    <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            <!-- <img src="{{ asset($photoProfilUrl) }}" alt="{{ auth()->user()->username }}" /> -->
            <img src="{{ asset('metronic/dist/assets/media/avatars/blank.png') }}" alt="{{ auth()->user()->username }}" />
        </div>
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <img alt="Logo" src="{{ asset('metronic/dist/assets/media/avatars/blank.png') }}" alt="{{ auth()->user()->username }}" />
                    </div>
                    <!--end::Avatar-->
                    <!--begin::Username-->
                    <div class="d-flex flex-column">
    ...
    <div class="app-navbar-item ms-2 ms-lg-6 me-lg-5">
        <!--begin::Link-->
        <a class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">

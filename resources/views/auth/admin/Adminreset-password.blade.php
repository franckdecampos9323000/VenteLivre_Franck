...
<html lang="en">
	<!--begin::Head-->
		<title>Nouveau mot de passe - Vente de livre</title>
		<meta charset="utf-8" />
						...
						<div class="w-lg-500px p-10">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="#" action="" method="post">
								...
								<div class="text-center mb-11">
									<!--begin::Title-->
									<h1 class="text-dark fw-bolder mb-3">Mon nouveau mot de passe</h1>
									<!--end::Title-->
									<!--begin::Subtitle-->
									<div class="text-gray-500 fw-semibold fs-6">Remplissez le formulaire</div>
									<!--end::Subtitle=-->
								</div>
								<!--begin::Heading-->
								<!--begin::Login options-->
								...
								<!--end::Login options-->
									...
									<div class="fv-row mb-3" data-kt-password-meter="true">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-lg form-control-solid"
                                                type="password" placeholder="Nouveau mot de passe" name="password" autocomplete="off" />
									...
									<div class="fv-row mb-3" data-kt-password-meter="true">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-lg form-control-solid"
                                                type="password" placeholder="Confirmer le mot de passe" name="password_confirmation" autocomplete="off" />
                                        ...
                                        <!--begin::Hint-->
                                        <div class="text-muted">
                                        Utilisez au moins 8 caractères dont des majuscules, miniscules et chiffres.
                                        </div>
                                        <!--end::Hint-->
									</div>
									<!--end::Input group=-->

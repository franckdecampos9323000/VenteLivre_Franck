                        ...
                        <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline @error('photo_profil') is-invalid @enderror" data-kt-image-input="true">
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset($photoProfilUrl) }})"></div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="email" name="email" class="form-control form-control-lg form-control @error('email') is-invalid @enderror" placeholder="{{ ('Email') }}" value="{{ auth()->user()->email }}" />
                                    </div>
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">{{$message}}</span>
                                    @enderror
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="username" class="form-control form-control-lg form-control @error('username') is-invalid @enderror" placeholder="{{ ('Nom d\'utilisateur') }}" value="{{ auth()->user()->username }}" />
                                    </div>
                                    @error('username')
                                        <span class="invalid-feedback" role="alert">{{$message}}</span>
                                    @enderror
                                ...
                                <div class="card-footer d-flex justify-content-end py-6 px-9">
                                    <a href="{{ route('home') }}" class="btn btn-secondary btn-active-light-primary me-2">Quitter</a>

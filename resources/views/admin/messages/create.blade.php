            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                ...
                <x-title
                    ...
                    <x-breadcrumb
                        ...
                        :text2="'Messages'"
                        :link3="route('admin.messages.create')"
                        :text3="'Envoyer un message'"
                        :link4="''"
                        :link5="''"
                    />
                    <!--End::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <!--end::Error-->
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form class="form" id="kt_account_profile_details_form" action="{{ route('admin.messages.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class=" col-lg-8 fv-row">
                                        <textarea rows="3" type="text" id="kt_docs_tinymce_basic"  name="content" class="form-control form-control-lg form-control @error('content') is-invalid @enderror"
                                ...
                                <div class="row mb-6">
                                    ...
                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Les users qui recevront un message"></i>
                                    </label>
                                    <!--end::Label-->
                                    <div class=" col-lg-8 fv-row">
                                        <!--begin::Solid input group style-->
                                        <div class="input-group input-group flex-nowrap">
                                        <span class="input-group-text"><i class="fa fa-desktop fs-2"></i></span>
                                        <div class="overflow-hidden flex-grow-1">
                                            <select name="users[]" class="form-select form-select @error('users') is-invalid @enderror" multiple="multiple" data-allow-clear="true" data-placeholder="Choisir les users" data-control="select2">
                                                @foreach ($users as $user)
                                                    @if($user->status == true)
                                                        <option value="{{ old('id', $user->id ?? '') }}" {{ in_array($user->id, old('users', $message->users->pluck('id')->toArray())) ? 'selected' : '' }}>{{ $user->username }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        <input type="text" class="form-control-lg form-control @error('senddate') is-invalid @enderror" value="{{ old('startdate', $message->senddate ? $message->senddate->format('d-m-Y') : '') }}" placeholder="Date d'envoi" name="senddate" id="kt_datepicker_1" data-input-format="d-m-Y"/>

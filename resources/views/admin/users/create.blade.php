        ...
        <div id="kt_app_toolbar" class="app-toolbar pt-6 pb-2">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <x-title :pageTitle="'Ajouter un utilisateur'" />
                    <!--begin::Page title-->
                    <!--begin::Breadcrumb-->
                    <x-breadcrumb
                        :link1="route('home')"
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="image-input image-input-outline @error('photo_profil') is-invalid @enderror" data-kt-image-input="true">
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px"><img src="{{ old('photo_profil', $user->photo_profil ?? '') }}" /></div>
                            ...
                            <div class="fv-row mb-3" data-kt-password-meter="true">
                                ...
                                {{-- <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Mot de passe"></i>
                                </label> --}}
                                <!--end::Label-->
                                <!--begin::Input wrapper-->
                                <div class="position-relative mb-3">
                                    <input class="form-control form-control-lg form-control @error('password') is-invalid @enderror"

            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <x-breadcrumb
                        ...
                        :text2="'Annonces'"
                        :link3="route('admin.annonces.create')"
                        :text3="'Ajouter une annonce'"
                        :link4="''"
                        :link5="''"
                    />
                    <!--End::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="collapse show">
                        <!--begin::Form-->
                        <form class="form" id="annonces" action="{{ route('admin.annonces.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="repeated-form" data-repeater-list="annonces">
                                <div data-repeater-item>
                                    ...
                                    <div class="card-body border-top p-9">
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8">
                                                <!--begin::Image input-->
                                                <div class="image-input image-input-outline @error('annonces.*.image') is-invalid @enderror" data-kt-image-input="true">
                                                    <!--begin::Preview existing avatar-->
                                                    <div class="image-input-wrapper w-125px h-125px"><img src="{{ old('image', $annonce->image ?? '') }}" /></div>
                                                    <!--end::Preview existing avatar-->
                                                    <!--begin::Label-->
                                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow @error('image') is-invalid @enderror" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Choisir une image">
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                ...
                                                value="{{ old('title', $annonce->title ?? '') }}" placeholder="{{ ('Titre') }}"/>
                                                @error('title')
                                                <span class="invalid-feedback" role="alert">{{$message}}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <!--begin::Col-->
                                            <div class=" col-lg-8 fv-row">
                                                <textarea id="kt_docs_tinymce_basic" class="tox-target" width="50%" height="50%" type="text" name="description" class="form-control form-control-lg form-control @error('description') is-invalid @enderror"
                                                placeholder="{{ ('Description') }}">{{ old('description', $annonce->description ?? '') }}</textarea>
                                                @error('description')
                                                <span class="invalid-feedback" role="alert">{{$message}}</span>
                                                @enderror
                                            </div>
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a href="{{ route('admin.annonces.create') }}" class="btn btn-secondary btn-active-light-primary me-2">Rénitialiser</a>

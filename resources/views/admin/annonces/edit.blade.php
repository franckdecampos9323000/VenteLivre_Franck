            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form class="form" id="kt_account_profile_details_form" action="{{ route('admin.annonces.update', $annonce) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true">
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset('images/' . $annonce->image) }})"></div>
                                            ...
                                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Choisir une image">
                                                ...
                                                <!--begin::Inputs-->
                                                <input type="file" name="image" accept="image/*" value="{{ old('image', $annonce->image ?? '') }}"/>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class=" col-lg-8 fv-row">
                                        <textarea id="kt_docs_tinymce_basic"  rows="3" type="text" name="description" class="form-control form-control-lg form-control @error('description') is-invalid @enderror"
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a href="route('admin.annonces.index')" class="btn btn-light btn-active-light-primary me-2">Annuler</a>

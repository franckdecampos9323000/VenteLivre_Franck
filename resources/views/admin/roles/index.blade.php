        ...
        <div id="kt_app_toolbar" class="app-toolbar pt-6 pb-2">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <x-title :pageTitle="'Liste des rôles'"/>
                    <x-breadcrumb
                        :link1="route('home')"
                        :link2="route('admin.roles.index')"
                        :text2="'Rôle'"
                        :link3="route('admin.roles.index')"
                        :text3="'Liste des rôles'"
                        :link4="''"
                        :link5="''"
                    />
                    <x-add-button :link="route('admin.roles.create')" :name="'un rôle'" />
                </div>
            </div>
        </div>
                ...
                <table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    @foreach ($role->permissions as $permission)
                                        <li><span class="badge badge-primary" data-bs-toggle="tooltip" title="{{ $permission->description }}">{{ $permission->name }}</span></li>
                                    @endforeach
                                </ul>
                            </td>
                            ...
                            <td>
                                <a href="{{ route('admin.roles.edit', $role) }}" class="btn btn-icon btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Modifier le rôle">
                                ...
                                <form action="{{ route('admin.roles.destroy', $role->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="btn btn-icon btn-active-color-primary btn-sm" onclick="deleteline(event)" data-bs-toggle="tooltip" title="Supprimer le rôle">

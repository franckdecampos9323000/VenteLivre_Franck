        ...
        <div id="kt_app_toolbar" class="app-toolbar pt-6 pb-2">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <x-title :pageTitle="'Ajouter un role'" />
                    <!--begin::Page title-->
                    <!--begin::Breadcrumb-->
                    <x-breadcrumb
                        :link1="route('home')"
                        ...
                        :text2="'Rôles'"
                        :link3="''"
                        :text3="'Ajouter un rôle '"
                        :link4="''"
                        :link5="''"
                    />
                    <!--End::Breadcrumb->
                     <!--begin::Button-->
                    <x-back-button :link="route('admin.roles.index')" />
                    <!--begin::Button-->
                </div>
                <!--end::Toolbar wrapper-->
            </div>
                                        ...
                                        <tbody class="text-gray-600 fw-semibold">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-gray-800">Permissions
                                                    ...
                                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Permission"></i>
                                                </td>
                                                <!--end::Label-->
                                                <!--begin::Input group-->
                                                <td>
                                                    ...
                                                    <div class="">
                                                        @foreach($permission as $value)
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                                <label class="">
                                                                    <input class="permission-checkbox" type="checkbox" value="{{ $value->id }}" name="permission[]" />
